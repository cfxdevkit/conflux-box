      ...
      <Tabs defaultValue="signing" variant="outline">
        ...
        <Tabs.Panel value="signing" pt="md">
          <Stack gap="md">
            <Alert icon={<IconInfoCircle size={16} />} color="blue">
              <Text size="sm">
                Sign messages using DevKit managed accounts. These signatures can be used 
                for testing authentication flows and message verification.
              </Text>
            </Alert>
            ...
            {signature && (
              <Card withBorder padding="md" bg="gray.0">
                ...
                <Group gap="xs" mt="xs">
                  <Badge size="xs" color="blue">Chain: {chain}</Badge>
                ...
                <Card key={index} withBorder padding="sm" bg="gray.0">
                  ...
                  <Stack gap="xs">
                    <Group justify="space-between">
                      <Text size="xs" c="dimmed">Core Address:</Text>
                    ...
                    {account.evmAddress && (
                      <Group justify="space-between">
                        <Text size="xs" c="dimmed">eSpace Address:</Text>
                        <Code style={{ fontSize: '11px' }}>
                          {account.evmAddress}
                        </Code>
                      </Group>
