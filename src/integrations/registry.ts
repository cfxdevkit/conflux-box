...
export function registerIntegrations() {
  ...
  const ginsenSwapMetadata: IntegrationMetadata = {
    ...
    name: "GinsenSwap",
    description:
      "Innovative DEX on Conflux - Uniswap V3 compatible stablecoin DEX",
    category: "dex",
  ...
  registry.register(
    createIntegration(ginsenSwapMetadata, GinsenSwapIntegration)
  );
  registry.register(
    createIntegration(mesonBridgeMetadata, MesonBridgeIntegration)
  );
}
