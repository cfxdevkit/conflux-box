    ...
    return (
      <Card withBorder radius="md" p="lg">
        <Stack gap="md" align="center">
          <Text size="lg" fw={600}>GinsenSwap DEX</Text>
    ...
    <Card withBorder radius="md" p="lg">
      <Stack gap="md">
        ...
        <Group justify="space-between">
          <div>
            <Group gap="xs">
              <Text fw={600} size="lg">GinsenSwap</Text>
        ...
        <Card withBorder p="sm">
          <Group justify="space-between" mb="xs">
            <Text size="sm" fw={500}>Pool Fee</Text>
            <Text size="sm" fw={500}>Slippage</Text>
          </Group>
          <Group justify="space-between">
            <Select
              data={[
        ...
        {quote && (
          <Stack gap="xs">
            <Group justify="space-between">
              ...
              <Text size="sm">1 {fromToken} ≈ {(parseFloat(quote.amountOut) / parseFloat(amount)).toFixed(6)} {toToken}</Text>
            </Group>
            <Group justify="space-between">
              <Text size="sm" c="dimmed">Pool Fee</Text>
              <Text size="sm">{selectedFee / 10000}%</Text>
            </Group>
            <Group justify="space-between">
              <Text size="sm" c="dimmed">Slippage Tolerance</Text>
        ...
        <Text size="xs" c="dimmed" ta="center">
          Powered by GinsenSwap • Network: Conflux eSpace {currentNetwork === 'mainnet' ? 'Mainnet' : 'Testnet'}
        </Text>
      </Stack>
    </Card>
  );
