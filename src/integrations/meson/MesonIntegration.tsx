...
export const MesonBridgeIntegration: React.FC<IntegrationComponentProps> = ({
    ...
    return (
      <Alert icon={<IconInfoCircle size={16} />} color="yellow">
        <Stack gap="xs">
          ...
          <Text size="xs" c="dimmed">Limited functionality available on testnet/local networks.</Text>
        </Stack>
      </Alert>
    );
  }
  ...
  const selectedAccount = accountsData?.accounts && accountsData.accounts.length > 0 
    ...
    <Card withBorder radius="md" p="lg">
      <Stack gap="md">
        ...
        <Group justify="space-between">
          <div>
            <Group gap="xs">
              <Text fw={600} size="lg">Meson Bridge</Text>
        ...
        <Alert icon={<IconInfoCircle size={16} />} color="orange">
          <Stack gap="xs">
            <Text size="sm" fw={500}>EVM Compatible Only</Text>
            <Text size="xs">
          ...
          <div>
            ...
            {selectedAccount && (
              <Card withBorder p="xs" mt="xs">
                <Text size="xs" c="dimmed">Target Address:</Text>
        ...
        <Card withBorder p="md">
          <Stack gap="sm">
            ...
            <Alert icon={<IconInfoCircle size={16} />} color="blue" p="xs">
              <Text size="xs" fw={500} mb="xs">Having issues? Try manual bridging:</Text>
              <Stack gap={4}>
                <Text size="xs">1. Visit <Anchor href="https://meson.fi" target="_blank" size="xs">meson.fi</Anchor> directly</Text>
                <Text size="xs">2. Bridge to Conflux eSpace (CFX)</Text>
                <Text size="xs">3. Use address: {selectedAccount?.addresses.evm || 'Connect account first'}</Text>
              </Stack>
            </Alert>
          </Stack>
        </Card>
        ...
        {completedData && (
          <Card withBorder p="md" style={{ backgroundColor: 'var(--mantine-color-green-0)', borderColor: 'var(--mantine-color-green-3)' }}>
            <Stack gap="sm">
              <Group>
        ...
        <Card withBorder p="sm">
          <Text size="xs" c="dimmed" mb="xs" fw={500}>Bridge Info</Text>
          <Stack gap={4}>
            <Group justify="space-between">
              <Text size="xs" c="dimmed">Supported tokens:</Text>
              <Text size="xs" ff="monospace">USDT, USDC, BUSD</Text>
            </Group>
            <Group justify="space-between">
              <Text size="xs" c="dimmed">Fee:</Text>
              <Text size="xs" c="green">~0.1%</Text>
            </Group>
            <Group justify="space-between">
              <Text size="xs" c="dimmed">Speed:</Text>
              <Text size="xs" c="blue">1-3 minutes</Text>
            </Group>
          </Stack>
        </Card>
